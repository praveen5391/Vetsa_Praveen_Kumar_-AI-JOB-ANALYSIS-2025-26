...
│
├── Vetsa Praveen Kumar_AI_Job_Market_Analysis_2025_2026.ipynb     # Main analysis notebook
├── app.py                                                          # Streamlit dashboard
├── requirements.txt                                                # Python dependencies
├── README.md                                                       # This file
│
├── Vetsa Praveen Kumar_AI_Job_Market_Analysis_2025_2026_ProjectReport.docx  # Word report
│
...
```bash
jupyter notebook "Vetsa Praveen Kumar_AI_Job_Market_Analysis_2025_2026.ipynb"
```

Or open with JupyterLab:

```bash
jupyter lab "Vetsa Praveen Kumar_AI_Job_Market_Analysis_2025_2026.ipynb"
```
...
`Vetsa Praveen Kumar_AI_Job_Market_Analysis_2025_2026_ProjectReport.docx`
